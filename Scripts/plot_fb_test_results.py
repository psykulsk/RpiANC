...
axs[1][0].plot(correction_signal_right_channel)
axs[1][0].set_title('Correction signal right channel')
axs[1][0].grid(True)
axs[1][0].set_ylim(-1.0, 1.0)
axs[0][1].plot(error_signal_left_channel)
axs[0][1].set_title('Error signal left channel')
axs[0][1].grid(True)
